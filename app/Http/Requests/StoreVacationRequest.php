...
class StoreVacationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fromDate' => ['required', 'date','before_or_equal:toDate', new \App\Rules\DateRangeRule($this->contact->id,$this->fromDate, $this->toDate,false)],
            'toDate' => ['required', 'date', 'after_or_equal:fromDate', new \App\Rules\DateRangeRule($this->contact->id,$this->fromDate, $this->toDate,false)],
        ];
    }
