    ...
    <ShowLayout>
        ...
        <template v-slot:content>
            <div  class="flex items-center justify-end">
                <Link href="/contacts/create" class="hover:text-indigo-300 no-underline hover:underline flex items-center space-x-2 text-green-500">
