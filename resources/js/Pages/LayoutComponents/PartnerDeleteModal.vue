        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto flex justify-center items-center">
            <div id="popup-modal" tabindex="-1" class=" overflow-y-auto overflow-x-hidden relative bg-white rounded-lg shadow dark:bg-gray-700 max-w-md">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <button @click="deleteUser(modalPartnerId)" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Igen.
                    </button>
...
const {modalPartnerId, show} = defineProps(['modalPartnerId', 'show']);
...
const deleteUser = (modalPartnerId) => {
