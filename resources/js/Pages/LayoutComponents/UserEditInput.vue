<template>
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">User adatainak módosítása</h2>
        </div>
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="flex gap-x-4 sm:col-span-2 z-30">
                    <div class="flex h-6 items-center">
                        <input v-model="form.active_status" type="checkbox"  class="h-4 w-4" true-value="1" false-value="0">
                    </div>
                    <label class="text-sm leading-6 text-gray-600" id="switch-1-label">
                        Aktív
                    </label>
                    <div class="flex h-6 items-center">
                        <input v-model="form.can_modify" type="checkbox" true-value="1" false-value="0">
                    </div>
                    <label class="text-sm leading-6 text-gray-600" id="switch-1-label">
