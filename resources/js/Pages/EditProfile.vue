    ...
    <div class="bg-white">
        ...
        <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Profile módosítása</h2>
            </div>
...
const {user,userPermissions } = defineProps(['user','userPermissions']);
...
const submit = () => {
    form.post(`/users/profile/${user.id}`,{
        onSuccess: () => {
            snackbar.add({
                type: 'success',
